...
def sim_over_n(num_sims, k0, k, ld, d, factor_model, sigma, n_range,
    ...
    '''
    sample_tmp = sample_gm(model, k0, 1000, d)
...
max_iter_EM = 1000
tol_EM = .000001
name = "k0" + str(k0) + "_k" + str(k) + "_d" + str(d) + "_factormodel" + str(factor_model) + "_weightseven" + "_sigma" + str(sigma) +  "_factorweights" + str(factor_weights) +  "_factorthetas" + str(factor_thetas) 
...
# Run sim
random.seed(1)
sim = sim_over_n(num_sims=num_sims, k0=k0, k=k, ld=ld,
